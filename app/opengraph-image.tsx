...
export const alt = "Mehndi Night — Muhammad Zeeshan Azhar Malik";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#0b3b2b", color: "#fff4ca", fontFamily: "serif" }}>
      ...
      <div style={{ width: "100%", padding: "78px 100px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        <div style={{ color: "#e4ba63", fontSize: 28, letterSpacing: 12, textTransform: "uppercase", display: "flex" }}>Mehndi Night</div>
        ...
        <div style={{ marginTop: 34, color: "#f1d899", fontSize: 30, letterSpacing: 3, display: "flex" }}>FRIDAY · 6TH NOVEMBER 2026</div>
        <div style={{ marginTop: 16, color: "#f1d899", fontSize: 25, letterSpacing: 2, display: "flex" }}>WEST CANAL ROAD · FAROOQABAD, MANSOORABAD</div>
      </div>
    </div>,
    { ...size }
  );
